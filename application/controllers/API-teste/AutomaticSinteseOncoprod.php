    ...
    public function __construct()
    {
        ...
        $this->configs =
            [
                ...
                'fornecedorById' =>
                    [
                        'status' => TRUE, //TEM um BUG AKI
                        'id' => 115
                    ],
                'cotacaoById' =>
                    [
                        'status' => TRUE, //FALSE AKIII
                        'cd_cotacao' => 'COT3084-1131',
                    ],
                'checkDataFimCotacao' => FALSE,
                'checkEnabledAuto' => FALSE,
                'checkPrdCotRestriction' => FALSE,
                'checkVendaDif' => FALSE,
                'checkValorMinimo' => FALSE,
                'checkFormaPagamento' => FALSE,
                'checkPrazoEntrega' => FALSE,
                'checkPrdRestriction' => FALSE,
                'checkClientRestriction' => FALSE,
                'checkPrdStock' => TRUE,
                'checkPrdSent' => FALSE,
