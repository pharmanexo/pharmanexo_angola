...
class De_para_pagamento extends MY_Controller
{
    private $views;
    private $route;
    private $bio;
    ...
    public function __construct()
    {
        ...
        $this->views = "admin/apoio/de_para_pgto";
        $this->route = base_url("admin/apoio/de_para_pagamento");
    ...
    public function index()
    {
        ...
        $data['fp'] = $this->db->query("select *
                                            from formas_pagamento fpi
                                            where fpi.id not in (select fpd.id_forma_pagamento from formas_pagamento_depara fpd where fpd.integrador = 3)
                                            ")->result_array();
        $data['fp_apoio'] = $this->db->where('id_integrador', 3)->get('formas_pagamento_integradores')->result_array();
