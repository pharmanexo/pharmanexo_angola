...
class Distribuidores extends Admin_controller
{
    private $route, $views;
    ...
    {
        parent::__construct();
        $this->route = base_url('admin/compras_coletivas/distribuidores');
        $this->views = "admin/compras_coletivas/distribuidores/";
