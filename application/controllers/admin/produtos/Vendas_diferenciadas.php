...
class vendas_diferenciadas extends Admin_controller
{
    private $route;
    private $views;
    ...
    public function __construct()
    {
        ...
        $this->route = base_url('admin/produtos/vendas_diferenciadas');
        $this->views = 'admin/produtos/vendas_diferenciadas';
