...
class Cotacoes_automaticas extends Admin_controller
{
    private $route, $views;
    ...
    public function __construct()
    {
        ...
        $this->route = base_url('admin/relatorios/cotacoes_automaticas');
        $this->views = "admin/relatorios/cotacoes_automaticas";
    ...
    {
        $page_title = 'Relatório de Cotações Automáticas';
    ...
    public function datatables($id_fornecedor)
    {
        ...
        $data = $this->datatable->exec(
                ...
                null,
                "nivel = 2 AND submetido = 1 AND {$where}"
        );
