...
class Cotacoes_manuais extends Admin_controller
{
    private $route, $views;
    ...
    public function __construct()
    {
        ...
        $this->route = base_url('admin/relatorios/cotacoes_manuais');
    ...
    public function datatables($id_fornecedor)
    {
        ...
        $data = $this->datatable->exec(
            ...
            null,
            "nivel = 1 AND submetido = 1 AND {$where}"
        );
    ...
    public function datatables_detalhes($cd_cotacao, $id_fornecedor)
    {
        $data = $this->datatable->exec(
            ...
            "cp.cd_cotacao = '{$cd_cotacao}' AND cp.id_fornecedor = {$id_fornecedor} AND cp.nivel = 1 and cp.submetido = 1"
        );
