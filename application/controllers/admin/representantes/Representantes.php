...
class Representantes extends Admin_controller
{
    private $route, $views;
    ...
    public function __construct()
    {
        ...
        $this->route = base_url('admin/representantes/representantes');
        $this->views = 'admin/representantes/';
    ...
    public function updateStatus($id, $opt)
    {
        if ($this->representante->updateStatus($id, $opt)) {
            ...
            $output = ['type' => 'success', 'message' => 'Status Alterado com Sucesso!'];
        } else {
            $output = [
                'type' => 'warning',
