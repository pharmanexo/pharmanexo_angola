...
class Dashboard extends Conv_controller
{
    ...
    public function __construct()
    {
        ...
        $this->route = base_url("convidados/dashboard/");
        $this->views = "convidados/";
    ...
    {
        $data['header'] = $this->tmp_conv->header(['title' => 'Portal do Comprador']);
        $data['navbar']  = $this->tmp_conv->navbar();
        $data['sidebar'] = $this->tmp_conv->sidebar();
        $data['heading'] = $this->tmp_conv->heading(['page_title' => 'Portal do Comprador']);
