...
class CotacoesTeste extends MY_Controller
{
        ...
        switch (strtoupper($integrador)) {
            case 'SINTESE':
                ...
                if (isset($produto) && !empty($produto)) {
                    ...
                    $client = new SoapClient("http://c7.plataformasintese.com:8080/IntegrationService.asmx?WSDL");
                    $location = 'http://c7.plataformasintese.com:8080/IntegrationService.asmx';
