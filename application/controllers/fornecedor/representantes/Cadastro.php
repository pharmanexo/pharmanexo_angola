...
class Cadastro extends MY_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->route = base_url('fornecedor/representantes/cadastro');
        $this->views = 'fornecedor/representantes/';
    ...
    public function datatables()
    {
        $datatables = $this->datatable->exec(
            ...
            [
                ...
                [ 'db' => 'representantes.estado', 'dt' => 'estado' ],
                [ 'db' => 'representantes.comissao', 'dt' => 'comissao'],
                [ 'db' => 'representantes.status', 'dt' => 'status' ]
            ],
            [
                ['representantes_fornecedores', 'representantes.id = representantes_fornecedores.id_representante']
            ],
            'status != 3 and representantes_fornecedores.id_fornecedor = '. $this->session->id_fornecedor
        );
