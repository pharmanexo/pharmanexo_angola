...
class Supervisao extends MY_Controller
{
    private $route, $views;
    ...
    {
        parent::__construct();
        $this->route = base_url('fornecedor/representantes/supervisao');
        $this->views = "fornecedor/representantes/supervisao";
    ...
    {
        $page_title = 'Gerentes e Supervisores';
    ...
    private function form($id)
    {
        ...
        $data['dados'] = $this->db->where('id', $id)->get('representantes_fornecedores')->row_array();

        $est = $this->db->where('id_representante', $data['representante']['id'])->get('representantes_estados')->result_array();
        $cli = $this->db->where('id_representante', $data['representante']['id'])->get('representantes_clientes')->result_array();
    ...
    public function datatables()
    {
        $datatables = $this->datatable->exec(
            ...
            [
                ...
                ['db' => 'representantes_fornecedores.gerente', 'dt' => 'gerente'],
                ['db' => 'representantes_fornecedores.email_gerente', 'dt' => 'email_gerente'],
                ['db' => 'representantes_fornecedores.supervisor', 'dt' => 'supervisor'],
                ['db' => 'representantes_fornecedores.email_supervisor', 'dt' => 'email_supervisor'],
