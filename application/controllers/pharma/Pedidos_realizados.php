...
class Pedidos_realizados extends Rep_controller
{
    ...
    public function __construct()
    {
        ...
        $this->route = base_url("pharma/pedidos_realizados/");
    ...
    public function index()
    {
        ...
        $data['url_cancel'] = base_url("pharma/pedidos/cancelRequest");
        $data['url_update'] = base_url("pharma/pedidos/open/");
    ...
    public function to_datatable()
    {
        $r = $this->datatable->exec(
            ...
            [
                ...
                [
                    ...
                    'formatter' => function($d, $r){
                        $soma = $this->db->query("SELECT sum(quantidade_solicitada * preco_desconto) as total from pedidos_representantes_produtos where id_pedido = {$r['id']}")->row_array()['total'];
            ...
            'compradores.id = ' .$this->session->id_cliente
        );
