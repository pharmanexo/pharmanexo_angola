...
class M_grupo_usuario_rota extends MY_Model
{

    protected $table = 'grupos_usuarios_rotas';
     ...
     * @return array
     */
    public function get_routes($tipo_usuario)
    {
        if (!isset($tipo_usuario)) return false;
