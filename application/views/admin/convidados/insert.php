        ...
        <div class="content__inner">
            <form id="formCliente" action="<?php echo $form_action; ?>" method="POST" enctype="multipart/form-data">
                <ul class="nav nav-tabs" id="myTab" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" id="cliente-tab" data-toggle="tab" href="#tabCliente" role="tab" aria-controls="cliente" aria-selected="true">Dados</a>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link" id="anexo-tab" data-toggle="tab" href="#tabAnexo" role="tab" aria-controls="anexo" aria-selected="false">Anexos</a>
                    </li>
                </ul>
                            ...
                            <div class="col-md-3">
                                <div class="card">
                                    ...
                                    <div class="card-body text-center py-5" data-toggle="tooltip" title="Clique para alterar">
                                        <label for="logo">
                                            <img src="<?php echo base_url('images/avatar-empresa-360sites.png') ?>" alt="" style="width: 150px; height: auto">
                                        ...
                                        <div class="form-row">
                                            <div class="col-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="cnpj" data-inputmask="cnpj">
                                                </div>
                                            </div>
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="col-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="telefone" data-inputmask="tel">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-row">
                                            <div class="col-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="cep" id="cep" data-inputmask="cep">
                                                </div>
                                            </div>
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            <label class="btn btn-block btn-outline-secondary" for="documento_alvara" id="lb_documento_alvara">
                                                ...
                                                <input type="file" class="form-control" id="documento_alvara" name="documento_alvara" hidden>
                                            </label>
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <label class="btn btn-block btn-outline-secondary" for="cartao_cnpj">
                                                ...
                                                <input type="file" hidden class="form-control" onchange="labelArquivo($('#cartao_cnpj'), $('#span_cartao_cnpj'))" id="cartao_cnpj" name="cartao_cnpj" value="<?php echo set_value('cartao_cnpj', $default, TRUE); ?>">
                                            </label>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <label class="btn btn-block btn-outline-secondary" for="copia_afe">
                                                ...
                                                <input type="file" hidden class="form-control" onchange="labelArquivo($('#copia_afe'), $('#span_copia_afe'))" id="copia_afe" name="copia_afe" value="<?php echo set_value('copia_afe', $default, TRUE); ?>">
                                            </label>
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <label class="btn btn-block btn-outline-secondary" for="responsabilidade_tecnica">
                                                ...
                                                <input type="file" hidden class="form-control" onchange="labelArquivo($('#responsabilidade_tecnica'), $('#span_responsabilidade_tecnica'))" id="responsabilidade_tecnica" name="responsabilidade_tecnica" value="<?php echo set_value('responsabilidade_tecnica', $default, TRUE); ?>">
                                            </label>
                                        </div>
                                    </div>
                                </div>
