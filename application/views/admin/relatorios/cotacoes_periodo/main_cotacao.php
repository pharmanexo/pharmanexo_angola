    ...
    <script>
        $(function() {
            ...
            var dt = $('#data-table').DataTable({
                ...
                columns: [
                    { name: 'cp.id_pfv', data: 'id_pfv' },
                    { name: 'cp.produto', data: 'produto' },
                    { name: 'pc.marca', data: 'marca' },
                    { name: 'cp.qtd_solicitada', data: 'qtd_solicitada' },
                    { name: 'cp.qtd_embalagem', data: 'qtd_embalagem' },
                    { name: 'cp.preco_marca', data: 'preco_marca' },
                ],
