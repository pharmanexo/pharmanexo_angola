        ...
        <form id="formRepresentante" enctype="multipart/form-data" 
            ...
            <nav>
                <div class="nav nav-tabs" id="nav-tab" role="tablist">
                    <a class="nav-item nav-link active" id="nav-home-tab" data-toggle="tab" href="#nav-representante" role="tab" aria-controls="nav-home" aria-selected="true">Dados Representante</a>
                    ...
                    <a class="nav-item nav-link <?php echo (isset($tipo_cadastro) && $tipo_cadastro == 2) ? '' : 'disabled' ?>" id="nav-comissao-tab" data-toggle="tab" href="#nav-comissao" role="tab" aria-controls="nav-comissao" aria-selected="false">Configurar</a>
               </div>
            </nav>
            <div class="tab-content" id="nav-tabContent">
                <div class="tab-pane fade show active" id="nav-representante" role="tabpanel" aria-labelledby="nav-home-tab">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="form-row">
                                <div class="col-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="cnpj" id="cnpj" data-inputmask="cnpj" value="<?php echo set_value('cnpj', $default, TRUE); ?>">
                                    </div>
                                </div>
                                <div class="col-8">
                                    <div class="form-group">
                                ...
                                <div class="col-3">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="text" class="form-control" id="telefone" name="telefone_comercial" data-inputmask="tel"value="<?php echo set_value('telefone_comercial', $default, TRUE); ?>">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-3">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="text" class="form-control" id="celular" name="telefone_celular" data-inputmask="tel"value="<?php echo set_value('telefone_celular', $default, TRUE); ?>">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="form-row">
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        <label>Selecionar Estados</label>
                                        <select class="select2" name="estados[]" id="estados" multiple data-placeholder="Selecione">
                                            <?php foreach($estados as $estado): ?>
                                                <option value="<?php echo $estado['id']; ?>" <?php echo (isset($rep_estado) && in_array($estado['id'], $rep_estado)) ? 'selected' : '' ?> ><?php echo $estado['descricao']; ?></option>
                                            <?php endforeach ?>
                                        </select>
                                    </div>
                                </div>     
                            ...
                            <div class="row">
                                <div class="col-4">
                                    <div class="form-group">
                                        ...
                                        <label class="btn btn-block btn-outline-secondary" for="copia_social" id="lb_copia_social">
                                            <span id="span_copia_social">Contrato Social</span>
                                            <input type="file" hidden class="form-control" onchange="labelArquivo($('#copia_social'), $('#span_copia_social'))" id="copia_social" name="copia_social"
                                ...
                                <div class="col-4">
                                    <div class="form-group">
                                        ...
                                        <label class="btn btn-block btn-outline-secondary" for="copia_cnpj">
                                            ...
                                            <input type="file" hidden class="form-control" onchange="labelArquivo($('#copia_cnpj'), $('#span_copia_cnpj'))" id="copia_cnpj" name="copia_cnpj"
                                ...
                                <div class="col-4">
                                    <div class="form-group">
                                        ...
                                        <label class="btn btn-block btn-outline-secondary" for="copia_id">
                                            ...
                                            <input type="file" hidden class="form-control" onchange="labelArquivo($('#copia_id'), $('#span_copia_id'))" id="copia_id" name="copia_id"
                ...
                <div class="tab-pane fade" id="nav-comissao" role="tabpanel" aria-labelledby="nav-comissao-tab">
                    <div class="card">
                        <div class="card-header text-right">
                            <button type="button" id="delete_comissao" class="btn btn-danger d-inline-block">Excluir Selecionados</button>
                            <button type="button" id="nova_comissao" class="btn btn-primary d-inline-block">Novo</button>
                        </div>
                        <div class="card-body">
...
<script>
    ...
    $(function () {
            ...
            $.ajax({
                ...
                success: function(xhr) {
                    if (xhr.type == 'warning') {
                        ...
                        formWarning(xhr);
                        setTimeout(function() { window.location.href = $('#formRepresentante').data('route_success'); }, 1500);
                    }
                },
                error: function(xhr) {
                    console.log(xhr);
        ...
        $('#nova_comissao').on('click', function () { open_modal(url_modal); });
    ...
    function validaForm() {
        if (type == 1) {
            ...
            if ( $('#senha').val() != "" && resp != 1 ) { return false; } 
            else { return true; }
        }
    }
