                    ...
                    <form action="<?php echo $form_action; ?>" class="" id="formCad">
                        <div class="row">
                            <div class="col-12">
                                ...
                                <p>Informe o CNPJ para iniciar o processo de cadastro</p>
                            </div>
                        </div>
                        <div class="form-group">
                            <input type="text" id="cnpj" placeholder="Informe seu CNPJ" name="cnpj" class="form-control text-center">
                        </div>
                        <hr>
