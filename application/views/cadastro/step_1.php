                        ...
                        <div class="row">
                            <div class="col-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="cnpj" name="cnpj" value="<?php if (isset($dados['cnpj'])) echo $dados['cnpj']; ?>" class="form-control text-center">
                                </div>
                            </div>
                            <div class="col-8">
                                <div class="form-group">
                                    <label for="">Nome Fantasia</label>
                                    <input type="text" id="nome_fantasia" value="<?php if (isset($dados['nome_fantasia'])) echo $dados['nome_fantasia']; ?>" name="nome_fantasia" class="form-control text-center">
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="">Razão Social</label>
                            <input type="text" id="razao_social" value="<?php if (isset($dados['razao_social'])) echo $dados['razao_social']; ?>" name="razao_social" class="form-control text-center">
                        </div>
