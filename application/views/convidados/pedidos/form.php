...
<div class="content">
    ...
    <div class="content__inner">
        <form 
            ...
            <input type="hidden" id="id_fornecedor" name="id_fornecedor" value="<?php if (isset($id_fornecedor)) echo $id_fornecedor; ?>">
            ...
            <div class="card">
                        ...
                        <div class="col-6">
                            <a data-toggle="collapse" class="pull-right text-right d-inline-block" href="#test-block"
                               aria-expanded="true" aria-controls="test-block">
                                <h3 class="card-title pull-left d-inline-block">Novo Pedido</h3>
                            </a>

                        </div>
                        <div class="col-6 text-right">
                            <input type="checkbox" name="prioridade" value="1" <?php if (isset($dados['prioridade']) && $dados['prioridade'] == 1) echo 'checked'?> > Pedido Urgente
                        </div>
                    </div>
                ...
                <div id="test-block" class="card-body collapse show">
                    ...
                    <div class="row">
                        <div class="col-12 col-lg-6">
                            <div class="form-group">
                                <label for="">Selecione o comprador</label>
                                <select name="id_comprador" 
                                    class="w-100 form-control select2" 
                                    id="select_clientes" 
                                    style="width: 100%"
                                    data-value="<?php if (isset($dados)) echo $dados['id_comprador'] ?>"
                                    data-url="<?php echo $select_clientes; ?>"
                                    data-urlinfo="<?php echo base_url("representantes/pedidos/get_info/"); ?>"
                                    <?php echo (isset($dados)) ? 'disabled' : '' ?> >
                                </select>
                            </div>
                        </div>
                        <div class="col-12 col-lg-3">
                            <label for="">UF Comprador</label>
                            <input type="text" class="form-control text-center" name="uf_comprador" value="<?php if (isset($dados['uf_comprador'])) echo $dados['uf_comprador']; ?>" id="uf_comprador" readonly placeholder="Selecione o comprador">
                        </div>
                        <div class="col-12 col-lg-3">
                            <label for="">Data</label>
                            <input type="text" class="form-control text-center" readonly value="<?php echo date("d/m/Y H:i", time()) ?>">
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-12 col-lg-4">
                            <div class="form-group">
                                ...
                                <input type="hidden" id="condicao_pagamento" name="condicao_pagamento">
                                <select class="form-control w-100" id="formasPagamento" name="id_forma_pagamento" style="width: 100%"
                                        data-value="<?php if (isset($dados['id_forma_pagamento'])) echo $dados['id_forma_pagamento']; ?>"
                                        data-url="<?php echo $select_formas_pagamento; ?>"
                                    <?php echo (isset($dados)) ? 'disabled' : '' ?> required>
                                </select>
                            </div>
                        </div>
                        <div class="col-12 col-lg-4">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="text" id="prazo_entrega" name="prazo_entrega" value="<?php if (isset($dados['prazo_entrega'])) echo $dados['prazo_entrega']; ?>" class="form-control text-center" <?php echo (isset($dados)) ? 'disabled' : '' ?> required>
                                    <input type="hidden" id="id_prazo_entrega" value="<?php if (isset($dados['id_prazo_entrega'])) echo $dados['id_prazo_entrega']; ?>" name="id_prazo_entrega" class="form-control text-center">
                        ...
                        <div class="col-12 col-lg-4">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" id="valor_minimo" name="valor_minimo" value="<?php if (isset($dados['valor_minimo'])) echo number_format($dados['valor_minimo'], 2, ',', '.'); ?>" class="form-control text-right" data-inputmask="money" <?php echo (isset($dados)) ? 'disabled' : 'readonly' ?>>
                                </div>
                            </div>
                        </div>
                    </div>
                    <?php if (!isset($dados)) { ?>
                        <div class="row">
                            <div class="col-12">
                                <button id="btnCadastroPedido" class="btn btn-light btn-block" style="height: 100%"><i class="fas fa-pills"></i> Inserir Produtos do Pedido</button>
                            </div>
                        </div>
                    <?php } ?>
                </div>
        ...
        <form 
            ...
            <input type="hidden" id="id_pedido" name="id_pedido" value="<?php echo isset($dados) ? $dados['id'] : ''; ?>">
            ...
            <div class="card <?php if (!isset($dados)) {
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-7">
                            <div class="form-group">
                                ...
                                <select class="form-control w-100" id="slct_produtos" data-url="<?php echo $select_produtos; ?><?php if (isset($dados['uf_comprador'])) echo $dados['uf_comprador']; ?>" style="width: 100%"></select>

                                <small>Produtos em vermelho: sem estoque</small>
                            </div>
                        </div>
                        <div class="col-1 mt-4" id="btn_historico" hidden>
                             <button type="button" class="btn btn-primary" style="margin-top: 10px" data-toggle="modal" data-target="#historicoModal" title="Histórico de ofertas"><i class="fas fa-hand-holding-usd"></i></button>
                        </div>
                        <div class="col-2">
                            <div class="form-group">
                        ...
                        <div class="col-2">
                            <div class="form-group">
                                ...
                                <input type="text" id="preco" name="preco_unidade" readonly placeholder="0,00" data-inputmask="money4" class="form-control">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-3">
                            <div class="form-group">
                                ...
                                <input type="number" id="quantidade" min="0" name="quantidade_solicitada" class="form-control" required disabled>
                            </div>
                        </div>
                        <div class="col-3">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" id="desconto" name="desconto" value="0,00" data-inputmask="money" class="form-control" disabled>
                                </div>
                            </div>
                        </div>
                        <div class="col-3">
                            <div class="form-group">
                                <label for="">Valor Unit Desc</label>
                                <div class="input-group">
                                    <div class="input-group-prepend">
                                        <div class="input-group-text">R$</div>
                                    </div>
                                    <input type="text" id="valor_desconto" name="preco_desconto" max="100" data-inputmask="money4" class="form-control" disabled>
                                </div>
                            </div>
                        </div>
                        <div class="col-3">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <button id="" class="btn btn-success btn-block" style="height: 100%"><i class="fas fa-plus"></i> Adicionar</button>
                        </div>
                    </div>
                </div>
            </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function() { habilitarButtons(); });
            ...
            $.get(url, function (xhr) {
                ...
                slct_prods.select2({
                    ...
                    templateSelection: function (data, container) {
                        ...
                        $.post(url_preco, {codigo: $('#cd_produto_fornecedor').val(), uf: $('#uf_comprador').val()}, function(xhr) {
            ...
            slct_prods.select2({
                ...
                templateResult: function (data, container) {
                    ...
                    if (data.ean == null || data.ean == ''){
                         ret = `${data.codigo} -  ${data.nome_comercial}`;
                    }else{
                         ret = `${data.ean} -  ${data.nome_comercial}`;
                    }
    ...
    function somarTotal(format = null) 
    {
        ...
        var preco = $('#valor_desconto').val().replace('.', '').replace(',', '.');
        var target = $('#total');
