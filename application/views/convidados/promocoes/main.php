    ...
    $(function () {
        ...
        var dt1 = $('#data-table').DataTable({
            ...
            rowCallback: function (row, data) {
                var btnModal = $(`<a data-toggle="tooltip" title="Incluir no Pedido" data-qtd="${data.quantidade}" data-idprod="${data.id}" class="btn btn-sm btn-info text-white"><i class="fas fa-cart-plus"></i></a>`);
                ...
                btnModal.click(function (e) {
                    ...
                    Swal.fire({
                        ...
                        inputValidator: (value) => {
                            if (value > qtd) {
                                return 'Não é permitido quantidades maiores que o estoque disponível'
                            }
                            if (value == 0) {
