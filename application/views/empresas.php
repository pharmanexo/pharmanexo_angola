        ...
        <div class="col-12 col-lg-6"
            ...
            <div class="row my-3">
                ...
                <h3 class="text-white" style="margin-top: 180px; padding: 100px; text-align: center">
                    ...
                    <br><br>
                    <a href="https://pharmanexo.com.br" target="_blank" class="btn btn-light mt-3 px-5">Conheça a
                        Pharmanexo</a>
                </h3>
                <div class="text-center w-100 position-absolute" style="bottom: 0"><p class="text-white text-center">©
                        2019 Pharmanexo</p></div>
            </div>
        </div>
        <div class="col-12 col-lg-6 bg-light formColumn">
            <div class="card text-center shadow " style="background-color: rgba(255,255,255,.7); margin-top: 150px"
                 id="telaLogin">
                <div class="card-body">
                    <div class="p-2">
                        <img class=" mx-auto d-block" style="width: 50px; height: auto"
                             src="<?php echo base_url('images/icone_pharmanexo.png'); ?>">
                    </div>
                    <h3>Selecionar Empresa</h3>
                    <p>O seu login está cadastrado em mais de um fornecedor, então selecione <br> abaixo a empresa que
                        deseja acessar.</p>
                    ...
                    <form id="formSelecionarEmpresa" method="post" class="frm" action="<?php echo $frm_action; ?>">
                        ...
                        <button type="submit" form="formSelecionarEmpresa" id="selectEmpresa"
...
<script>
    $(function (e){
        $('#selectEmpresa').click(function (e){


            $(this).html(`<i class="fa fa-spinner fa-spin"></i> Acessando...`).attr('disabled', 'disabled');
            $('#formSelecionarEmpresa').submit();
