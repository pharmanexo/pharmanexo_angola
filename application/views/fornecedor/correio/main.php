...
<body class="bg-light">
  ...
  <li class="nav-item">
    <a class="nav-link" id="trashbox" data-toggle="tab" data-action="trashbox" href="#contact" role="tab" aria-controls="contact" aria-selected="false">Lixeira</a>
                            ...
                            <table id="data-table" class="table table-condensend table-hover" data-delete="<?php echo $url_delete; ?>" data-del_mais="<?php echo $url_delete_multiplo; ?> " data-url="<?php echo $datatable_src; ?>" data-update="<?php echo $url_open_message; ?>">
                                    <thead>
                                    <tr>
                                            <th></th>
                                            <th>Data</th>
