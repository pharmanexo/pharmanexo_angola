    ...
    <div class="content__inner">
        ...
        <div class="card">
            <div class="card-header">
                ...
                <?php if (isset($options_fornecedores)) { ?>
                    <hr>
...
<div class="modal fade" id="upgradeModal" tabindex="-1" role="dialog" aria-labelledby="upgradeModalLabel"
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 style="font-size: 20px;margin-top: 10px;" class="modal-title upgradeModal"
                    id="upgradeModalLabel"></h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body modalUpgradeDePara">
                <div class="col-12 mt-2 text-right">
                    <button type="button"
                            style="position: relative;z-index:1;width:100px;height: 40px;right: 40px;top: 11px;"
                            title="Combinar Produtos" class="btn btn-primary btnCombinarUpgrade"
                            data-original-title="Combinar Produtos">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="table" style="margin-top: -110px;">
                                <table id="data-tableUpgradeDePara"
                                       class="table w-100 table-hover data-tableUpgradeDePara"
                                       data-url="<?php echo $datatables; ?>" data-url2="<?php echo $url_combinar; ?>">
                                    <thead>
                                    <tr>
                                        <th></th>
