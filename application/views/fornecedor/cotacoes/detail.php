    ...
    <div class="content">
        ...
        <div class="content__inner">
            ...
            <?php if ($cotacao['data_fim'] < date('Y-m-d H:i:s', strtotime("-1 hour"))) : ?>
                <div class="alert alert-danger" role="alert"><i class="fas fa-exclamation-triangle"></i> Esta cotação se encontra encerrada.
                </div>
            <?php endif; ?>
            ...
            <div class="row mb-3">
                <div class="col-12">
                    <div class="enviado" style="width: 15px; height: 15px; border-radius: 20%; border: 1px solid; display: inline-block"></div> &nbsp;Respondida&nbsp;&nbsp;
