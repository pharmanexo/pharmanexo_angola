...
<div class="content">
    ...
    <div class="content__inner">
        ...
        <input type="hidden" name="integrador" id="integrador" value="<?php echo $integrador; ?>"> <input type="hidden"
                                                                                                          name="cd_cotacao"
                                                                                                          id="cd_cotacao"
                                                                                                          value="<?php if (isset($cotacao['cd_cotacao'])) echo $cotacao['cd_cotacao']; ?>">
        <input type="hidden" name="id_cotacao" id="id_cotacao"
               value="<?php if (isset($cotacao['id_cotacao'])) echo $cotacao['id_cotacao']; ?>"> <input type="hidden"
                                                                                                        name="dt_inicio_cotacao"
                                                                                                        id="dt_inicio_cotacao"
                                                                                                        value="<?php if (isset($cotacao['data_inicio'])) echo $cotacao['data_inicio']; ?>">
        <input type="hidden" name="dt_fim_cotacao" id="dt_fim_cotacao"
               value="<?php if (isset($cotacao['data_fim'])) echo $cotacao['data_fim']; ?>"> <input type="hidden"
                                                                                                    name="cnpj_comprador"
                                                                                                    id="cnpj_comprador"
                                                                                                    value="<?php if (isset($cotacao['cnpj'])) echo $cotacao['cnpj']; ?>">
        <input type="hidden" name="razao_social" id="razao_social"
               value="<?php if (isset($cotacao['cliente']['razao_social'])) echo $cotacao['cliente']['razao_social']; ?>">
        <input type="hidden" name="id_cliente" id="id_cliente"
               value="<?php if (isset($cotacao['cliente']['id'])) echo $cotacao['cliente']['id']; ?>"> <input
                type="hidden" name="id_estado" id="id_estado"
                value="<?php if (isset($cotacao['estado']['id'])) echo $cotacao['estado']['id']; ?>"> <input
                type="hidden" name="uf_cotacao" id="uf_cotacao"
                value="<?php if (isset($cotacao['uf_cotacao'])) echo $cotacao['uf_cotacao']; ?>">
        ...
        <div class="card">
            <div class="card-header">
                <div class="row">
                    <div class="col text-left">
                        <div class="checkbox">
                            <input type="checkbox" value="1" id="revisarCotacao"
                                   data-integrador="<?php echo $integrador; ?>"
            ...
            <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="text" class="form-control"
                                       value="<?php echo $cotacao['cliente']['cnpj'] . ' - ' . $nome_comprador; ?>"
                                       disabled>
                            </div>
                    ...
                    <div class="col-3">
                        <div class="form-group">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="text" class="form-control"
                                       value="<?php echo (!empty($cotacao['cliente']['cidade'])) ? "{$cotacao['cliente']['cidade']} - {$cotacao['cliente']['estado']}" : $cotacao['cliente']['estado']; ?>"
                                       disabled>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col">
                        <div class="form-group">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="text" class="form-control"
                                       value="<?php if (isset($cotacao['data_inicio'])) echo date('d/m/Y H:i:s', strtotime($cotacao['data_inicio'])); ?>"
                                       disabled>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col">
                        <div class="form-group">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="text" class="form-control"
                                       value="<?php if (isset($cotacao['data_fim'])) echo date('d/m/Y H:i:s', strtotime($cotacao['data_fim'])); ?>"
                                       disabled>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col">
                        <div class="form-group">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="text" class="form-control"
                                       value="<?php if (isset($cotacao['condicao_pagamento'])) echo $cotacao['condicao_pagamento']; ?>"
                                       disabled>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col">
                        <div class="form-group">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="text" class="form-control"
                                       value="<?php if (isset($cotacao['itens'])) echo $cotacao['itens']; ?>" disabled>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-6">
                        <label>Forma de Pagamento</label> <select class="select2" id="id_forma_pagamento"
                    ...
                    <div class="col-12">
                        <div class="form-group">
                            <label for="obs">Observações da cotação</label> <input type="text" name="obs" id="obs"
                                                                                   class="form-control"
                                                                                   maxlength="<?php echo (strtoupper($integrador) == 'SINTESE') ? '500' : '300'; ?>"
        ...
        <div class="row mb-3">
            <div class="col-12">
                <div class="enviado"
                     style="width: 15px; height: 15px; border-radius: 20%; border: 1px solid; display: inline-block"></div> &nbsp;Respondida&nbsp;&nbsp;
                <div class="nenviado"
...
<script>
    ...
    $(function () {
        ...
        $('#revisarCotacao').on('change', function (e) {
            ...
            $.ajax({
                ...
                type: 'post',
                data: {status: s, integrador: integrador},
        ...
        $("#btnEnviar").on('click', function (e) {
            ...
            if (ofertas > 0) {
                ...
                data.push({name: "obs", value: $("#obs").val()});
                data.push({name: "prazo_entrega", value: $("#prazo_entrega").val()});
                data.push({name: "id_forma_pagamento", value: $("#id_forma_pagamento").val()});
                data.push({name: "cnpj_comprador", value: $("#cnpj_comprador").val()});
                data.push({name: "razao_social", value: $("#razao_social").val()});
                data.push({name: "dt_inicio_cotacao", value: $("#dt_inicio_cotacao").val()});
                data.push({name: "dt_fim_cotacao", value: $("#dt_fim_cotacao").val()});
                data.push({name: "uf_cotacao", value: $("#uf_cotacao").val()});
                data.push({name: "id_cotacao", value: $("#id_cotacao").val()});
                data.push({name: "id_estado", value: $("#id_estado").val()});
                data.push({name: "id_cliente", value: $("#id_cliente").val()});
                data.push({name: "cd_cotacao", value: $("#cd_cotacao").val()});
                data.push({name: "integrador", value: $("#integrador").val()});
                    ...
                    success: function (xhr) {
                        ...
                        if (xhr.type !== undefined) {
                            ...
                            if (xhr.type == 'warning') {
                                ...
                                formWarning({type: 'success', message: 'Espelho da cotação criado com sucesso'});
    ...
    function save_item(key) {
        ...
        data.unshift({name: "obs", value: $("#obs").val()});
        data.unshift({name: "prazo_entrega", value: $("#prazo_entrega").val()});
        data.unshift({name: "id_forma_pagamento", value: $("#id_forma_pagamento").val()});
        data.unshift({name: "cnpj_comprador", value: $("#cnpj_comprador").val()});
        data.unshift({name: "dt_inicio_cotacao", value: $("#dt_inicio_cotacao").val()});
        data.unshift({name: "uf_cotacao", value: $("#uf_cotacao").val()});
        data.unshift({name: "id_estado", value: $("#id_estado").val()});
        data.unshift({name: "id_cliente", value: $("#id_cliente").val()});
        data.unshift({name: "cd_cotacao", value: $("#cd_cotacao").val()});
        data.unshift({name: "integrador", value: $("#integrador").val()});
