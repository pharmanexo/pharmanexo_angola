                    ...
                    <div class="card-header <?php if (isset($produto['classCard'])) echo $produto['classCard']; ?>" id="heading<?php echo $k; ?>">
                        ...
                        <div class="row mt-3 <?php if (isset($produto['classCard'])) echo $produto['classCard']; ?>">
                            ...
                            <div class="col-12 col-lg-2">
                                ...
                                <a href="<?php echo $url_findProduct; ?><?php echo $identificacao_produto ?>/<?php echo $cotacao['cliente']['id'] ?>/<?php echo $produto['cotado']['cd_produto_comprador']; ?>" data-depara="" data-idelem="<?php echo $k; ?>" data-codproduto="<?php if (isset($produto['cotado']['cd_produto_comprador'])) echo $produto['cotado']['cd_produto_comprador']; ?>" data-produto="<?php echo explode(' ', $produto['cotado']['ds_produto_comprador'])[0]; ?>" data-toggle="tooltip" title="Upgrade De -> Para">
