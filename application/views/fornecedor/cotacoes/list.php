                ...
                <div class="card-header <?php if (isset($produto['classCard'])) echo $produto['classCard']; ?>" id="heading<?php echo $k; ?>">
                    <div class="row mt-3 <?php if (isset($produto['classCard'])) echo $produto['classCard']; ?>">
                        ...
                        <div class="col-12 col-lg-3">
                            <button id="fazerDePara<?php echo $k; ?>" data-idelem="<?php echo $k; ?>" data-sintese1="<?php echo var_dump($produto['cotado']['id_produto_sintese']); exit;$id_produto_sintese; ?>" data-codproduto="<?php if (isset($produto['cotado']['cd_produto_comprador'])) echo $produto['cotado']['cd_produto_comprador']; ?>" data-produto="<?php echo explode(' ', $produto['cotado']['ds_produto_comprador'])[0]; ?>" class="btn btn-block btn-secondary btn_depara" type="button" data-toggle="collapse" data-target="#collapseDePara<?php echo $k; ?>" aria-expanded="false" aria-controls="collapseDePara">
