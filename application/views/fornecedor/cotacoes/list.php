                    ...
                    <div class="card-header <?php if (isset($produto['classCard'])) echo $produto['classCard']; ?>" id="heading<?php echo $k; ?>">
                        ...
                        <div class="row mt-3 <?php if (isset($produto['classCard'])) echo $produto['classCard']; ?>">
                            ...
                            <div class="col-12 col-lg-2">
                                ...
                                <button style="border: none;" id="UpgradeDePara<?php echo $k; ?>" data-idelem="<?php echo $k; ?>" data-codproduto="<?php if (isset($produto['cotado']['cd_produto_comprador'])) echo $produto['cotado']['cd_produto_comprador']; ?>" data-produto="<?php echo explode(' ', $produto['cotado']['ds_produto_comprador'])[0]; ?>" class="btn_upgradeDePara" type="button" data-toggle="modal" data-target="#upgradeModal" title="Upgrade De -> Para">
