                                                ...
                                                <td class="text-nowrap ml-0">
                                                    <div style="display: inline-block;" class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                                            ...
                                                            <a class="dropdown-item removerDePara" data-toggle="modal" title="Remover De/Para" data-cod="<?php echo $prod['codigo'] ?>" data-cliente="<?php echo $cotacao['cliente']['id']; ?>" data-sintese="<?php echo $identificacao_produto; ?>" data-idprodutosintese="<?php echo $id_produto_sintese; ?>" data-codcomprador="<?php echo $produto['cotado']['cd_produto_comprador']; ?>" data-classcontainer="codigoProduto<?php echo "{$prod['codigo']}{$produto['cotado']['cd_produto_comprador']}" ?>">
                ...
                <div class="card-header <?php if (isset($produto['classCard'])) echo $produto['classCard']; ?>" id="heading<?php echo $k; ?>">
                    <div class="row mt-3 <?php if (isset($produto['classCard'])) echo $produto['classCard']; ?>">
                        ...
                        <div class="col-12 col-lg-3">
                            <button id="fazerDePara<?php echo $k; ?>" data-idelem="<?php echo $k; ?>" data-idprodutosintese="<?php echo $id_produto_sintese; ?>" data-codproduto="<?php if (isset($produto['cotado']['cd_produto_comprador'])) echo $produto['cotado']['cd_produto_comprador']; ?>" data-produto="<?php echo explode(' ', $produto['cotado']['ds_produto_comprador'])[0]; ?>" class="btn btn-block btn-secondary btn_depara" type="button" data-toggle="collapse" data-target="#collapseDePara<?php echo $k; ?>" aria-expanded="false" aria-controls="collapseDePara">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="table" style="margin-top: -110px;">
                                    <table id="data-tableDePara<?php echo $k; ?>" class="table w-100 table-hover" data-url="<?php echo $datatables; ?>" data-url2="<?php echo $url_combinar; ?>" data-sintese="<?php echo $identificacao_produto; ?>" data-idprodutosintese="<?php echo $id_produto_sintese; ?>">
                                        <thead>
                                            <tr>
                                                <th></th>
                                                <th>Código</th>
