        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="table-responsive">
                    <table id="data-table" class="table table-condensend table-hover" data-url="<?php echo $to_datatable; ?>" data-cotacao="<?php echo $url_cotacao; ?>" data-ocultar="<?php echo $url_ocultar; ?>" data-info="<?php echo $url_info; ?>">
                        <thead>
                            <tr>
                                <th></th>
                                <th></th>
