                                        ...
                                        <td>
                                            ...
                                            >
                                                <?php foreach ($options_fornecedores as $f) { ?>
                                                    <?php if (isset($prod['fornecedor_cotacao'])) { ?>
                                                        <option value="<?php echo $f['id'] ?>" <?php echo ($f['id'] == $prod['fornecedor_cotacao']) ? 'selected' : '' ?> ><?php echo $f['fornecedor'] ?></option>
                                                    <?php } else { ?>
                                                        <option value="<?php echo $f['id'] ?>" <?php echo ( $f['id'] == $this->session->id_fornecedor) ? 'selected' : '' ?> ><?php echo $f['fornecedor'] ?></option>
                                                    <?php } ?>
                                                <?php } ?>
                                            </select>
                                        </td>
