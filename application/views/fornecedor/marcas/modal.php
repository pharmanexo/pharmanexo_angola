        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form data-url="<?php echo $form_action ?>" id="form" method="POST">
                    <input type="hidden" name="marca" id="codigo" value="">
                    ...
                    <div class="form-group">
                        ...
                        <select name="id_marca" id="marcas" class="w-100 form-control" style="width: 100%" data-url="<?php echo $select2_marcas; ?>" data-value=""></select>
                    </div>
                </form>
            </div>
