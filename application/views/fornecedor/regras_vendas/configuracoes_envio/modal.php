...
<script>
    $(function() {
        ...
        $("#tipo").select2({ dropdownParent: $('#modalConfiguracoes') });
        ...
        $('#formConfiguracoes').on('submit', function(e) {
            ...
            $.ajax({
                ...
                beforeSend: function(jqXHR, settings) {
                    ...
                    if ( $("#observacao").val() == '' ) {
                        formWarning({ type: 'warning', message: "O campo observação é obrigatório!"});
                        return jqXHR.abort();
                    }  

                    if ( $("#estados").val() == '' ) {
                        formWarning({ type: 'warning', message: "O campo estados é obrigatório!"});
                        return jqXHR.abort();
                    }  
                },
