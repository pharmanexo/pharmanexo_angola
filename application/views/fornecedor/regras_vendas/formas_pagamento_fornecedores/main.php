                            ...
                            <div class="row mx-auto mt-3">
                                <div class="col-12">
                                    <div class="table-responsive">
                                        <table id="data-table-estado" class="table table-condensend table-hover" style="width: 100%;" data-url="<?php echo $to_datatable_estado; ?>" data-update="<?php echo $url_update; ?>" data-delete_multiple="<?php echo $url_delete_multiple ?>">
                                            <thead>
                                                <tr>
                                                    <th>
                                                        <div class="checkbox">
                        ...
                        <?php if ($this->session->userdata('id_tipo_venda') != 1) : ?>
                            <div class="tab-pane fade" id="tabCnpj" role="tabpanel" aria-labelledby="cnpj-tab">
                                <div class="row mx-auto mt-3">
                                    <div class="col-12">
                                        <div class="table-responsive">
                                            <table id="data-table-cnpj" class="table table-condensend table-hover" style="width: 100%;" data-url="<?php echo $to_datatable_cnpj; ?>" data-update="<?php echo $url_update; ?>">
                                                <thead>
                                                    <tr>
                                                        <th>
                                                            <div class="checkbox">
    ...
    $(function() {
        var dt1 = $('#data-table-estado').DataTable({
            ...
            columns: [
                ...
                {name: 'estados.descricao', data: 'estado'},
                {name: 'formas_pagamento.descricao', data: 'formaPagamento'}
            ],
            columnDefs: [
