        ...
        <form action="<?php if (isset($form_action)) echo $form_action; ?>" method="POST" id="formRestricoes">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <table id="table-restricao" class="table table-condensend table-hover w-100" data-url="<?php echo $datatable_produtos; ?>" data-selected=" <?php if (isset($labelSubtitle)) echo $labelSubtitle ?>">
                                <thead>
                                <tr>
                                    <th>
                                        <div class="checkbox">
