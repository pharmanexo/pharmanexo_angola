                            ...
                            <div class="form-group">
                                ...
                                <?php } else { ?>
                                    ...
                                    <input type="hidden" name="id"
                                           value="<?php if (isset($representante['id_rep_forn'])) echo $representante['id_rep_forn']; ?>"
                                           class="form-control">
                            ...
                            <div class="form-group">
                                <select multiple id="listElements">
                                    <?php foreach ($estados as $estado) { ?>
                                        <option value="<?php  echo $estado['id'];  ?>" <?php if (isset($estado['checked']) && $estado['checked'] == true) echo 'selected'; ?>><?php echo $estado['descricao']; ?></option>
                                    <?php } ?>
                                </select>
                            </div>
                        </div>
                            ...
                            <div class="form-group">
                                <select multiple id="listClientes">
                                    <?php foreach ($clientes as $cliente) { ?>
                                        <option value="<?php echo $cliente['id'] ?>" <?php if (isset($cliente['checked']) && $cliente['checked'] == true) echo 'selected'; ?>><?php echo "{$cliente['cnpj']} - {$cliente['razao_social']}"; ?></option>
                                    <?php } ?>
                                </select>
                            </div>
                        </div>
