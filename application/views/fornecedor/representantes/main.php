                ...
                <div class="row mx-auto mt-3">
                    <div class="col-12 col-sm">
                        <div class="table-responsive">
                            ...
                            <table id="table-representante" class="table table-condensend table-hover w-100" 
...
<script>
    var url_status = $('#table-representante').data('status');
    var url_delete_multiple = $('#table-representante').data('delete_multiple');
    var url_update = $('#table-representante').data('update');

    $(function() {
        var table = $('#table-representante').DataTable({
            processing: true,
            serverSide: true,
            lengthChange: false,
            responsive: true,
            pageLength: 10,
            ajax: {
                url: $('#table-representante').data('url'),
                type: 'POST',
                dataType: 'json'
            },
            columns: [
                ...
                { data: 'telefone_comercial', name: 'telefone_comercial', className: 'text-nowrap'},
