    ...
    $(function() {
        ...
        var table = $('#data-table').DataTable({
            ...
            columns: [
                ...
                { name: 'representantes_fornecedores.gerente', data: 'gerente', className: 'text-nowrap' },
                { name: 'representantes_fornecedores.supervisor', data: 'supervisor', className: 'text-nowrap' },
            ...
            rowCallback: function(row, data) {
                ...
                var btnDelete = $(`<a href="${url_update}${data.id_representante}" class="text-primary"><i class="fas fa-edit"></i></a>`);
