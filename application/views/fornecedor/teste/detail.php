...
<div class="content">
    ...
    <div class="content__inner">
            ...
            <input type="hidden" name="cd_cotacao" id="cd_cotacao" value="<?php if (isset($cotacao['cd_cotacao'])) echo $cotacao['cd_cotacao']; ?>">
            <input type="hidden" name="id_cotacao" id="id_cotacao" value="<?php if (isset($cotacao['id_cotacao'])) echo $cotacao['id_cotacao']; ?>">
            <input type="hidden" name="dt_inicio_cotacao" id="dt_inicio_cotacao" value="<?php if (isset($cotacao['data_inicio'])) echo $cotacao['data_inicio']; ?>">
            <input type="hidden" name="dt_fim_cotacao" id="dt_fim_cotacao" value="<?php if (isset($cotacao['data_fim'])) echo $cotacao['data_fim']; ?>">
            ...
            <input type="hidden" name="id_cliente" id="id_cliente" value="<?php if (isset($cotacao['cliente']['id'])) echo $cotacao['cliente']['id']; ?>">
            <input type="hidden" name="id_estado" id="id_estado" value="<?php if (isset($cotacao['estado']['id'])) echo $cotacao['estado']['id']; ?>">
            <input type="hidden" name="uf_cotacao" id="uf_cotacao" value="<?php if (isset($cotacao['uf_cotacao'])) echo $cotacao['uf_cotacao']; ?>">
                ...
                <div class="card-header">
                    <div class="row">
                        <div class="col text-left">
                            <div class="checkbox">
                                <input type="checkbox" value="1" id="revisarCotacao" data-cotacao="<?php echo $cotacao['cd_cotacao']; ?>" <?php if ($cotacao['revisao'] == 1) echo 'checked' ?> >
                   ...
                   <div class="row">
                    ...
                    <div class="row">
                        <div class="col-6">
                            ...
                            <select class="select2" id="id_forma_pagamento" name="id_forma_pagamento">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="obs" id="obs" class="form-control" maxlength="<?php echo (strtoupper($integrador) == 'SINTESE' ) ? '500' : '300'; ?>" value="<?php if(isset($observacao)) echo $observacao ?>">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <!-- Lista de Produtos -->
            <?php $this->load->view("fornecedor/teste/list"); ?>
    </div>
</div>
    ...
    $(function () {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.post(url_ocultar, {}, function (xhr) {
                        formWarning(xhr);
                        setTimeout(function() { window.location.href = url_lista }, 1500);
                    }, 'JSON')
                    .fail(function(xhr) {});
                }
            })
        ...
        $('[data-desconto]').each(function (i, v) {
            ...
            me.on('blur', function () {
                ...
                if ( typeof preco_unidade == 'string' ) { preco_unidade = parseFloat(preco_unidade); }
                if ( typeof preco == 'string' ) { preco = parseFloat(preco); }
                if ( typeof desconto == 'string' ) { desconto = parseFloat(desconto); }
                if ( typeof preco_caixa == 'string' ) { preco_caixa = parseFloat(preco_caixa); }
        ...
        $("[data-selectfornecedor]").change(function(index, element) {
            ...
            $.ajax({
                url: url_price,
                type: 'post',
                data: { codigo: codigo, id_fornecedor: $(this).val(), id_estado: $("#id_estado").val(), id_cliente: $("#id_cliente").val()  },
                success: function(xhr) {
        ...
        $.ajax({
            ...
            success: function(xhr) {
                ...
                if ( xhr.type == 'warning' ) {
                    ...
                    setTimeout(function(){ card.removeClass('border-danger'); }, 3000);
                } else {

                    card.addClass('border-success');
                    setTimeout(function(){ card.removeClass('border-success'); }, 3000);
                }
