...
<?php foreach ($cotacao['produtos'] as $k => $produto): ?>
    ...
    <?php $identificacao_produto = ( $integrador == 'SINTESE' ) ? $produto['cotado']['id_produto_sintese'] : $produto['cotado']['cd_produto_comprador']; ?>
                            ...
                            <tbody>
                                <?php foreach ($produto['encontrados'] as $jj => $prod): ?>
                                        ...
                                        <tr class="<?php if (isset($prod['class'])) echo $prod['class']; ?> " data-qtdsolicitada="<?php echo $produto['cotado']['qt_produto_total'] ?>" id="<?php echo "row_{$k}_{$jj}_{$prod['codigo']}"; ?>">
                                            <td>
                                                <div class="checkbox">
                                                    <input 
                                                        ...
                                                        data-cd_comprador="<?php echo $produto['cotado']['cd_produto_comprador']; ?>"
                                                        name="marcas[<?php echo $jj ?>][marcado]"
                                            ...
                                            <td>
                                                <input type="text"
                                                    name="marcas[<?php echo $jj?>][preco_oferta]"
                                                    id="preco_unitario"
                                                    ...
                                                    data-key="produto-<?php echo $k; ?>"
                                                    class=" text-center form-control"
                                                    title="<?php echo ( isset($prod['ultima_oferta']) ) ? 'Ultima oferta: R$' . number_format($prod['ultima_oferta'], 4, ',', '.') : 'Sem oferta'; ?>"
                                                    data-toggle="tooltip"
                                                    <?php if( isset($produto['cotado']['restricao']) && $produto['cotado']['restricao'] == 1 ) echo 'readonly' ?>
                                                >
                                            </td>
                                            ...
                                            <td>
                                                <?php if ($checkFilial): ?>
                                                    <select
                                                        class="select2 selectDropDown"
                                                        name="marcas[<?php echo $jj?>][id_fornecedor]"
                                                        <?php foreach($prod['estoques'] as $estq): ?>
                                            ...
                                            <td class="text-nowrap ml-0">
                                                ...
                                                <div class="dropdown">
                                                    <a href="#" data-toggle="dropdown" class="dropdown-toggle text-secondary"
                                                        style="<?php if( isset($produto['cotado']['restricao']) && $produto['cotado']['restricao'] == 1 ) echo 'pointer-events: none' ?>"
                                                    >
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                                        ...
                                                        data-produto="<?php echo "obs_{$k}_{$jj}_{$prod['codigo']}"  ?>"
                                                        >
        ...
        <div class="card" id="card-produto-<?php echo $k; ?>">
            <div class="card-header <?php if(isset($produto['classCard'])) echo $produto['classCard']; ?>" id="heading<?php echo $k; ?>">
                <div class="row mt-3 <?php if(isset($produto['classCard'])) echo $produto['classCard']; ?>">
                    ...
                    <div class="col-12 col-lg-2">
                        <a href="<?php echo $url_findProduct; ?><?php echo $identificacao_produto ?>/<?php echo $cotacao['cliente']['id']; ?>" data-depara="" class="btn btn-block btn-danger">Fazer De -> Para</a>
                    </div>
                </div>
            </div>
        </div>
