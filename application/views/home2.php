            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form_container">
                        ...
                        <form id="FormContact" action="<?php echo base_url('contato/sendMessage'); ?>" method="post"
                              role="form">
                            <div class="form-row">
                                <div class="col-lg-6">
                                    <div>
                            ...
                            <div>
                                <input type="text" name="mensagem" required class="message-box"
                                       placeholder="Nos conte do que precisa *"/>
                            </div>
                            <div class="btnsubmit">
                    ...
                    <div class="map_container">
                        <div class="map">
                            <iframe style="border:0; width: 100%; height: 370px;"
                                    src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d7483.256305779943!2d-40.292836!3d-20.315653!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x2f91e8604faf31ef!2sPharmanexo%20Portal%20de%20Oportunidades%20de%20Produtos%20Farmac%C3%AAuticos!5e0!3m2!1spt-BR!2sbr!4v1590624053465!5m2!1spt-BR!2sbr"
    ...
    $(function (e) {
        ...
        $('#FormContact').on('submit', function (e) {
            ...
            $.post(url, data, function (xhr) {
                ...
                var alert = `<div class="alert alert-${xhr.type}" role="alert">${xhr.message}</div>`;
                mess.html(alert);
