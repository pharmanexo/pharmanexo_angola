        ...
        <div class="col-12 col-lg-6" style="background:url(<?php echo base_url('images/bg-login.jpg'); ?>); background-repeat: no-repeat; background-size: cover;">
            <div class="row my-3">
                <div class="co mt-4 ml-3">
                    <a href="/pharmanexo"><img class="d-block" src="<?php echo base_url('images/img/logo-branca.png'); ?>"></a>
                </div>
                ...
                <div class="text-center w-100 position-absolute" style="bottom: 0"><p class="text-white text-center">© 2019 - <?php echo date('Y', time()); ?> - Pharmanexo Intermediação de Negócios</p></div>
            </div>
        </div>
        <div class="col-12 col-lg-6 d-flex justify-content-center bg-light formColumn">


            <div class="card text-center shadow position-absolute " hidden  style=" margin-top: 680px" id="telaLogin">
                <div class="card-body">
                    <h3>Manutenção Programada</h3>
                    <br><br>
                    <p class="">Informamos que o sistema passará por uma manutenção no dia 02/07/2021 as 20:00h e ficará indisponível para acesso até as 22:00h.</p>

                </div>
            </div>
            <!-- card login -->
            <div class="card text-center shadow position-absolute "  style=" min-width: 400px; margin-top: 150px" id="telaLogin">
                <div class="card-body px-5">
                    ...
                    <form id="form" method="post" class="frmLogin" action="<?php echo $frm_action; ?>">
                        ...
                        <div style="margin-top:25px" class="form-group">
                            ...
                            <br>
                            <div class="col-12 controls" style="margin-top:25px;">
                                <a href="<?php echo base_url('representantes/login') ?>"  class="btn btn-secondary px-3 " style="width:200px">
                                    <i class="fas fa-arrow-circle-right"></i> Acesso Representante
                                </a>
                            </div>
                        </div>
                    </form>
            ...
            <!-- card nova senha -->
            <div class="card text-center position-absolute shadow "  style=" margin-top: 150px; opacity: 0" id="telaNovaSenha">
                <div class="card-body">
