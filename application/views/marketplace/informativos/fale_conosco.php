...
<div class="container py-3 mb-3">
    <div class="col-12 col-lg-4">
        <img src="images/sobre/sobre_5.jpg" class="img-fluid" alt="">
    </div>
    <div class="col-12 col-lg-8">
        <p id="u73862-2"><span class="services-title" id="u73862">A primeira plataforma do brasil especializados em produtos pré-vencidos, auxiliamos a Industria e grandes distribuidores a diminuir seus estoques, melhorar a perfomance, diminuir a perda de produtos por vencimento, e transformar um problema dos fornecedores em uma grande oportunidade para milhares de clientes.</span></p>
        <p id="u73862-3">&nbsp;</p>
