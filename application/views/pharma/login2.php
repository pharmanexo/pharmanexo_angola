        ...
        <div class="col-12 col-lg-6"
            ...
            <div class="row my-3">
                ...
                <h3 class="text-white" style="margin-top: 180px; padding: 100px; text-align: center">
                    INTEGRANDO TODA A CADEIA DE COMPRA DO SEGMENTO FARMA
                    <br><br>
        ...
        <div class="col-12 col-lg-6 d-flex justify-content-center bg-light formColumn">
            ...
            <div class="card text-center shadow position-absolute " hidden style=" margin-top: 150px" id="telaLogin">
                <div class="card-body">
                    ...
                    <br><br>
                    <p class="">Nosso sistema encontra-se em manutenção de banco de dados, previsão de retorno as 08:00h
                        do dia 11/10/2019.</p>

                </div>
            </div>
            <!-- card login -->
            <div class="card text-center shadow position-absolute "
                 style=" margin-top: 150px; border-radius: 5px !important;" id="telaLogin">
                <div class="card-body">
                    <h3>Portal de Pedidos</h3>
                    <p class="small">Para acessar o sistema é necessário digitar o login e senha.</p>
                    <form id="form" method="post" class="frmLogin" action="<?php echo $frm_action; ?>">
                        ...
                        <div class="form-group">
                            <div class="input-group mb-3">
                                ...
                                <input id="senha" type="password" class="form-control input-sm" name="senha"
            ...
            <div class="card text-center position-absolute shadow " style=" margin-top: 150px" id="telaNovaSenha">
                <div class="card-body">
                    <form id="formRecuperarSenha" method="post" action="<?php echo $frm_novasenha; ?>">
                        ...
                        <p class="small">Não tem problema, informe o e-mail cadastrado e iremos te ajudar a recuperar
                            seua senha.</p>
                        <!-- <div class="form-group">
                             <div class="input-group mb-3 mt-5">
                        ...
                        <div style="margin-top:25px" class="form-group">
                            ...
                            <div class="col-12 controls" style="margin-top:25px;">
                                <span style="padding-top: 10px;"><a id="voltarLogin"
                                                                    href="<?php echo base_url('login') ?>"
                                                                    style="text-decoration:none">Voltar para o login</a></span>
                            </div>
                        </div>
                    </form>
                    ...
                    <div class="col-6 ">
                        <a href="<?php echo base_url('Fornecedor') ?>" style="text-decoration: none;">
                            <button type="button" class="btn float-left btn-info "
                                    data-sitekey="6LcnlLkUAAAAAPg2mSRJPKhYX_mrRCx99FUwFuj2" data-callback='onSubmit'><i
