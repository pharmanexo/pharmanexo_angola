...
<div class="content">
    ...
    <div class="content__inner">
        <form
            ...
            <input type="hidden" id="id_pedido" name="id_pedido" value="<?php  if(isset($dados['id'])) echo $dados['id'];  ?>">
            <div class="card">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <button id="btnCadastroPedido" class="btn btn-light btn-block" style="height: 100%"><i
                                            class="fas fa-pills"></i> Inserir Produtos do Pedido
                                </button>
                            </div>
                        </div>
                    <?php } ?>
                        ...
                        <div class="row">
                            ...
                            <div class="col-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="preco" name="preco_unidade" readonly placeholder="0,00"
    ...
    function load_produtos(id_pedido) {
        dt = $('#table-produtos').DataTable({
            ...
            rowCallback: function (row, data) {
                ...
                var btnModal = $(`<a data-toggle="tooltip" title="Cancelar Item" class="btn btn-sm btn-danger text-white"><i class="fas fa-ban"></i></a>`);
                $('td:eq(7)', row).html(btnModal);
