...
<div class="header" style="background: #b5c4d0;">
    ...
    <ul class="top-nav">
        ...
        <?php if (isset($_SESSION['dados']['cnpj']) && isset($_SESSION['dados']['razao_social'])) { ?>
            <li class=""
                data-toggle="tooltip" <?php if (isset($_SESSION['empresas'])) { ?> title="Clique na seta para trocar de empresa" data-placement="top" <?php } ?>>
                <strong>CNPJ:</strong> <?php echo $_SESSION['dados']['cnpj'] ?> <br>
                <strong>Empresa:</strong> <?php echo $_SESSION['dados']['razao_social'] ?> <br>
            </li>
        <?php } ?>
        <li class="dropdown">
