<div class="header">
    ...
    <div class="header__logo ">
        <h1><a href="<?php echo base_url('dashboard') ?>"><img style="width: 70%;" class="img-fluid"
                                                               src="<?php echo base_url('images/img/logo-branca.png'); ?>"
                                                               alt=""></a></h1>
    </div>
    <ul class="top-nav">
        <li class="p-5 hidden-lg-down" id="search-cot">
            <div class="input-group" style="margin-top: 20px !important;">
                <div class="input-group-prepend">
                    <select name="s_integrador" data-toggle="tooltip" title="Selecione qual integrador da cotação"
                            id="s_integrador" style=""
                ...
                <input type="text" class="form-control busca" data-toggle="tooltip" title="Ex. COT9999-8899"
                       id="inptGetCotacao" placeholder="Buscar Cotacão">
        ...
        <?php if ($this->session->administrador == 0) { ?>
            <li class=""
                data-toggle="tooltip" <?php if (isset($_SESSION['empresas']) && $this->session->administrador == 0) { ?> title="Clique na seta para trocar de empresa" data-placement="top" <?php } ?>>
                    ...
                    <div class="dropdown-menu dropdown-menu-right"
                        ...
                        <?php foreach ($_SESSION['empresas'] as $empresa) { ?>
                            <a class="dropdown-item"
                               href="<?php echo base_url("login/selecionar_empresa/{$empresa['id']}") ?>">
        ...
        <li class="dropdown top-nav__notifications">
            <a href="" data-toggle="dropdown"
               class="<?php if (isset($notificacoes) && count($notificacoes) > 0) echo 'top-nav__notify'; ?>"
               id="btnNotfifications" aria-expanded="false"><i class="zmdi zmdi-notifications"></i></a>
                    ...
                    <?php if (isset($notificacoes) && !empty($notificacoes)): ?>
                        ...
                        <div class="listview__header">
                            ...
                            <div class="actions">
                                <a href="" class="actions__item zmdi zmdi-check-all"
                                   data-ma-action="notifications-clear" data-url="<?php echo $read_all; ?>"></a>
                            </div>
                        </div>
                        ...
                        <div class="listview__scroll scrollbar-inner">
                            ...
                            <?php foreach ($notificacoes as $notificacao): ?>
                                ...
                                <a href="<?php if (!empty($notificacao['url'])) echo $notificacao['url']; ?>"
                                   class="listview__item">

                                    <img src="<?php echo base_url("images/info/{$notificacao['type']}.png"); ?>"
                                         class="listview__img" alt="">

                                    <div class="listview__content" data-toggle="tooltip"
                                         title="<?php echo $notificacao['message']; ?> ">
    ...
    <div class="scroll-wrapper scrollbar-inner" style="position: relative;">
        <div class="calculator">
            <div class="row displayBox">
                <input class="displayText" id="display" style="background-color: transparent; border: none !important;"
                       value="0" onkeypress="return numeros(event)"/>
            </div>
