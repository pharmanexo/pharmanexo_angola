...
$config['mongo_db']['default']['hostname'] = '10.101.70.2';
$config['mongo_db']['default']['port'] = '27017';
$config['mongo_db']['default']['username'] = 'suporte';
$config['mongo_db']['default']['password'] = 'Pharma_TI_2019';
$config['mongo_db']['default']['database'] = 'pharmanexo';
