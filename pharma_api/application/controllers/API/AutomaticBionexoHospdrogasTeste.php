...
class AutomaticBionexoHospdrogasTeste extends CI_Controller
{
    /**
     * @author : Chule Cabral
     * Data: 01/11/2020
            ...
            foreach ($resultDepara as $keyProd => $value) {
                ...
                $arr =
                    [
                        ...
                        'validade' => $validade,
                        'qtd_unidade' => $params['qtd_unidade'],
                        'estoque' => (isset($checkEstoque['result']['total'])) ? $checkEstoque['result']['total'] : 0,
    ...
    public function index()
    {
        ...
        foreach ($getFornecedores['result'] as $fornecedor) {
            ...
            $margem_estoque = $this->db->where('id_fornecedor', $fornecedor['id_fornecedor'])
                ->get('margem_estoque')
                ->row_array();
