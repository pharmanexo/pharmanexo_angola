...
class AutomaticSinteseOncoprodHMG extends CI_Controller
{
    /**
     * @author : Chule Cabral
     * Data: 01/11/2020
    ...
    private function prodsEncontrados($params, $prodsCotacao)
    {
        ...
        foreach ($prodsCotacao as $key => $prod) {
            ...
            foreach ($resultDepara as $keyProd => $value) {
                ...
                if (isset($params['classe']) && $params['classe'] == 'ISENTO'){
                    $params['origem'] = '';
                }
                ...
                /**
                 * Verificar se o produto tem loja prioritária de saida
                 */
