...
class RequestCotacao extends CI_Controller
{
    ...
    {
        # Obtem fornecedores
        $fornecedores = $this->DB1->where('id not in(12,111,112,115,120,123,125,126,5038, 20, 180, 1002, 5039, 5018, 5046, 5010)')->where('sintese', 1)->get('fornecedores')->result_array();
