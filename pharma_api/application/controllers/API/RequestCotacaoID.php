...
class RequestCotacaoID extends CI_Controller
{
	...
	public function connectSintese($fornecedor, $cot = null)
	{
		try {
	...
	public function index()
	{
        ...
        #$fornecedores = $this->DB1->where('id', 180)->where('sintese', 1)->get('fornecedores')->result_array();
        ...
        try {
            ...
            if (isset($_GET['cotacao']) && isset($_GET['fornecedor'])){
                $fornecedor = $this->DB1->where('id', $_GET['fornecedor'])->where('sintese', 1)->get('fornecedores')->row_array();
                $cot = $_GET['cotacao'];
            ...
            $result = $this->connectSintese($fornecedor, $cot);
