...
class AutomaticsEngineOncoprod extends CI_Model
{
    private $bio;
    private $mix;
    private $oncoprod = [12, 111, 112, 115, 120, 123, 125, 126]; //MELHORAR ISSO
    ...
    public function submitEmail($params, $configs)
    {
        ...
        if ($configs['sendEmail']) {
            ...
            if (!IS_NULL($notify) && !empty($notify)) {
                ...
                //ENVIAR ESPELHOS SOMENTE PARA KARINA E GIOVANA
                $emails = "karina.souza@oncoprod.com.br, giovana.pessoa@oncoprod.com.br, rosangela.lima@oncoprod.com.br, weslley.conceicao@oncoprod.com.br";
               ...
               // $copia_o = "marlon.boecker@pharmanexo.com.br";
                ...
                $mail =
                    [
                        ...
                        #"destinatario" => "marlon.boecker@pharmanexo.com.br, clara.souza@oncoprod.com.br",
                        "copia_o" => $copia_o,
                        "c_copia" => $copia_o,
                        "msg" => $body,
