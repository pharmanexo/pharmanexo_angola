...
<<<<<<< HEAD
    ...
    maxOptionsText: function (numAll, numGroup) {
      return [
        (numAll == 1) ? 'Limite atingido ({n} item max)' : 'Limite alcançado ({n} itens max)',
        (numGroup == 1) ? 'Limite de grupo atingido (máximo de {n} itens)' : 'Limite de grupo atingido (máximo de {n} itens)'
      ];
    },
    selectAllText: 'Selecione tudo',
    deselectAllText: 'Remove seleção',
    doneButton: false,
